...
import edu.jabs.interpol.mundo.Ciudad;
import edu.jabs.interpol.mundo.CiudadNoAgregadaException;
import edu.jabs.interpol.mundo.Lugar;
import junit.framework.TestCase;

/**
 * Esta es la clase usada para verificar que los métodos de la clase Ciudad
...
public class CiudadTest extends TestCase
{
	...
	/**
	 * Construye una nueva ciudad vacía, llamada Bogotá, con descripcion La capital
	 * de Colombia y con el sospechoso
	 */
	...
	/**
	 * Se construye una ciudad Bogotá, con dos hijos Cartagena y Barranquilla.
	 * Barranquilla tiene la ciudad San Andrés como hija, y allí es donde está el
	 * sospechoso
	 */
	private void setupEscenario2( )
	{
		...
		catch ( CiudadNoAgregadaException e )
		{
			fail( e.getMessage( ) );
		}
	}
	...
	/**
	 * Construye una nueva ciudad vacía, llamada Bogotá, con descripcion La capital
	 * de Colombia y con el sospechoso. Además tiene tres lugares.
	 */
	 ...
	 * 1. Se construye una Ciudad con el nombre "Bogotá", la descripción "La capital
	 * de Colombia" y con tiempo de 3 y donde se encuentra el sospechoso<br>
	 * 2. Se obtienen los datos de la ciudad creada y concuerdan con los
	 * ingresados<br>
	 */
	public void testCiudadHoja( )
	{
		...
		assertNotNull( "El camino a la respuesta del árbol de una hoja debería ser válido",
				ciudad.darCaminoRespuesta( ) );
		assertEquals( "El camino a la respuesta del árbol de una hoja debería tener un elemento", 1,
				ciudad.darCaminoRespuesta( ).size( ) );
		assertNull( "El camino central de una hoja debería ser null", ciudad.darCentral( ) );
		assertNotNull( "A pesar que no tenga ciudades hijas, la lista no debería ser null",
				ciudad.darCiudadesHijas( ) );
		...
		assertNotNull( "El vector de nombres de los posibles destinos no debería ser null",
				ciudad.darNombresPosiblesDestinos( ) );
		assertEquals( "El tamaño de la lista de los nombres de los posibles destinos debería ser 0", 0,
				ciudad.darNombresPosiblesDestinos( ).size( ) );
	 ...
	 * darAltura<br>
	 * esHoja<br>
	 * <b> Objetivo: </b> Probar que se agrega correctamente tres ciudades a una
	 * hoja<br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * 5. El peso del árbol aumenta de acuerdo a la cantidad de ciudades
	 * agregadas<br>
	 * 6. Al tratar de agregar una ciudad cuando la actual ya tiene sus hijos se
	 * lanza una excepción<br>
	 */
	 ...
	 * cambiarCentral<br>
	 * darCentral<br>
	 * <b> Objetivo: </b> Probar que se cambia correctamente el hijo central de la
	 * hoja actual<br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * cambiarDerecho<br>
	 * darDerecho<br>
	 * <b> Objetivo: </b> Probar que se cambia correctamente el hijo derecho de la
	 * hoja actual<br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * cambiarIzquierdo<br>
	 * darIzquierdo<br>
	 * <b> Objetivo: </b> Probar que se cambia correctamente el hijo izquierdo de la
	 * hoja actual<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se cambia el hijo derecho de la hoja actual<br>
	 */
	 ...
	 * <b> Objetivo: </b> Probar que se cuenta correctamente la cantidad de
	 * ocurrencias en una hoja<br>
	 * <b> Resultados esperados: </b> <br>
	...
	public void testCiudad( )
	{
		...
		assertEquals( "El camino a la respuesta del árbol debería tener 3 elementos", 3,
				ciudad.darCaminoRespuesta( ).size( ) );
		...
		assertNotNull( "El vector de nombres de los posibles destinos no debería ser null",
				ciudad.darNombresPosiblesDestinos( ) );
		assertEquals( "El tamaño de la lista de los nombres de los posibles destinos debería ser 2", 2,
				ciudad.darNombresPosiblesDestinos( ).size( ) );
		assertEquals( "El peso de un árbol de una hoja es 4", 4, ciudad.darPeso( ) );
		assertEquals( "El tiempo de viaje debería ser 3", 3, ciudad.darTiempoViaje( ) );
		assertFalse( "El sospechoso no se tiene que encontrar en la ciudad ya que es una hoja",
				ciudad.estaSospechoso( ) );
		assertFalse( "La ciudad no debería ser una hoja", ciudad.esHoja( ) );
	}
	 ...
	 * darAltura<br>
	 * esHoja<br>
	 * <b> Objetivo: </b> Probar que se agrega correctamente tres ciudades al
	 * árbol<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se agregan tres ciudades a la ciudad actual.<br>
	 * 3. La cantidad de ciudades aumenta<br>
	 ...
	 * agregarLugar<br>
	 * darNombresLugares<br>
	 * <b> Objetivo: </b> Probar que se agrega correctamente tres lugares al
	 * árbol<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se agregan tres lugares a la ciudad actual<br>
	 * 2. Al tratar de agregar un lugar cuando la ciudad actual ya tiene sus lugares
	 * completos se lanza una excepción<br>
	 */
	public void testAgregarLugar( )
	{
		...
		Lugar lugar1 = new Lugar( "Lugar 1", "Descripcion del Lugar 1", 3 );
		ciudad.agregarLugar( lugar1 );
		assertEquals( "La cantidad de lugares que tiene la ciudad es incorrecta", 1,
				ciudad.darNombresLugares( ).size( ) );
		Lugar lugar2 = new Lugar( "Lugar 2", "Descripcion del Lugar 2", 6 );
		ciudad.agregarLugar( lugar2 );
		assertEquals( "La cantidad de lugares que tiene la ciudad es incorrecta", 2,
				ciudad.darNombresLugares( ).size( ) );
		Lugar lugar3 = new Lugar( "Lugar 3", "Descripcion del Lugar 3", 23 );
		ciudad.agregarLugar( lugar3 );
		assertEquals( "La cantidad de lugares que tiene la ciudad es incorrecta", 3,
				ciudad.darNombresLugares( ).size( ) );
	}
	 ...
	 * darAltura<br>
	 * agregarCiudad<br>
	 * <b> Objetivo: </b> Probar que se calcula correctamente la altura al ir
	 * agrando correctamente tres ciudades al árbol<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. De acuerdo al orden en que son agregadas las ciudades se va calcula
	 * correctamente el peso del árbol<br>
	 */
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darCaminoRespuesta<br>
	 * <b> Objetivo: </b> Probar que se obtiene correctamente el camino hacia la
	 * hoja con el sospechoso<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se agregan tres ciudades a la ciudad actual.<br>
	 * 3. La cantidad de ciudades aumenta<br>
	 * 4. La altura del árbol pasa a ser de 2 a 4<br>
	...
	public void testDarCaminoRespuesta( )
	{
		...
		for ( int i = 0; i < respuesta.size( ); i++ )
		{
			...
			{
				case 0:
					assertEquals( "El camino hacia la hoja con el sospechoso es incorrecto", "Bogotá",
							(String) respuesta.get( 0 ) );
					break;
				case 1:
					assertEquals( "El camino hacia la hoja con el sospechoso es incorrecto", "Barranquilla",
							(String) respuesta.get( 1 ) );
					break;
				case 2:
					assertEquals( "El camino hacia la hoja con el sospechoso es incorrecto", "San Andrés",
	...
	public void testDarCentral( )
	{
		...
		assertEquals( "La descripcion de la ciudad es incorrecta", "Descripcion",
				ciudad.darCentral( ).darDescripcion( ) );
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darCiudad<br>
	 * <b> Objetivo: </b> Probar que se obtiene correctamente una ciudad que esta en
	 * la rama de la ciudad<br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darCiudadesHijas<br>
	 * <b> Objetivo: </b> Probar que se obtiene correctamente la cantidad de
	 * ciudades hijas<br>
	 * <b> Resultados esperados: </b> <br>
	...
	public void testDarCiudadesHijas( )
	{
		...
		for ( int i = 0; i < respuesta.size( ); i++ )
		{
			...
			if ( !(ciudad.darNombreCiudad( ).equals( "Barranquilla" )
					|| ciudad.darNombreCiudad( ).equals( "Cartagena" )) )
			{
	...
	public void testDarDerecho( )
	{
		...
		assertEquals( "La descripcion de la ciudad es incorrecta", "Descripcion",
				ciudad.darDerecho( ).darDescripcion( ) );
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darInorden<br>
	 * <b> Objetivo: </b> Probar que se obtenga el recorrido en inorden de un
	 * árbol.<br>
	 * <b> Resultados esperados: </b> <br>
	 * Se crea una lista para guardar los resultados, y después de llamar el método
	 * esta lista tiene los elementos organizados en inorden<br>
	 */
	...
	public void testDarIzquierdo( )
	{
		...
		assertEquals( "La descripcion de la ciudad es incorrecta", "Descripcion",
				ciudad.darIzquierdo( ).darDescripcion( ) );
	...
	public void testDarLugar( )
	{
		...
		assertEquals( "La descripcion del lugar es incorrecta", "Descripcion del Lugar 1",
				ciudad.darLugar( "Lugar 1" ).darPista( ) );
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darNombreCiudad<br>
	 * <b> Objetivo: </b> Probar que se obtiene correctamente el nombre de la
	 * ciudad<br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darNombresLugares<br>
	 * <b> Objetivo: </b> Probar que se obtiene correctamente los nombres de los
	 * lugares de la ciudad<br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * darNombresLugares<br>
	 * <b> Objetivo: </b> Probar que se obtiene correctamente los nombres de los
	 * posibles destinos de la ciudad (los hijos)<br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * darPeso<br>
	 * agregarCiudad<br>
	 * <b> Objetivo: </b> Probar que se calcula correctamente el peso al ir
	 * agregando correctamente tres ciudades al árbol<br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darPostorden<br>
	 * <b> Objetivo: </b> Probar que se obtenga el recorrido en postorden de un
	 * árbol.<br>
	 * <b> Resultados esperados: </b> <br>
	 * Se crea una lista para guardar los resultados, y después de llamar el método
	 * esta lista tiene los elementos organizados en postorden<br>
	 */
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darPreorden<br>
	 * <b> Objetivo: </b> Probar que se obtenga el recorrido en preorden de un
	 * árbol.<br>
	 * <b> Resultados esperados: </b> <br>
	 * Se crea una lista para guardar los resultados, y después de llamar el método
	 * esta lista tiene los elementos organizados en preorden<br>
	 */
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darTiempoViaje<br>
	 * <b> Objetivo: </b> Probar que se obtenga correctamente el tiempo de viaje a
	 * la ciudad<br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * esHoja<br>
	 * <b> Objetivo: </b> Probar que calcule correctamente que la ciudad sea una
	 * hoja<br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * estaSospechoso<br>
	 * <b> Objetivo: </b> Probar que calcule correctamente que el sospechoso se
	 * encuentra en la ciudad<br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * 2. Retorna null cuando se quiere viajar a una ciudad inexistente o que no es
	 * hija<br>
	 */
