...
/**
 * Esta es la clase usada para verificar que los métodos de la clase Interpol
...
public class InterpolTest extends TestCase
{
	 ...
	 * 2. Se obtienen los datos de Interpol creado y concuerdan con los
	 * ingresados<br>
	 */
	public void testInterpol( )
	{
		...
		assertEquals( "La lista del camino a la respuesta debería ser vacía", 0,
				interpol.darCaminoRespuesta( ).size( ) );
		...
		assertEquals( "El tamaño de la lista del recorrido por inordenn debería ser 0", 0,
				interpol.darInorden( ).size( ) );
		assertNotNull( "La lista de los nombres de los lugares de la ciudad actual no debería ser null",
				interpol.darNombresLugaresCiudadActual( ) );
		assertEquals( "El tamaño de la lista de los nombres de los lugares de la ciudad actual debería ser 0", 0,
				interpol.darNombresLugaresCiudadActual( ).size( ) );
		assertNotNull( "La lista de los nombres de los posibles destinos de la ciudad actual no debería ser null",
				interpol.darNombresPosiblesDestinos( ) );
		assertEquals( "El tamaño de la lista de los posibles destinos de la ciudad actual debería ser 0", 0,
				interpol.darNombresPosiblesDestinos( ).size( ) );
	 ...
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se construye Interpol vacía<br>
	 * 2. Se carga la informacion del archivo de propiedades 3. Se obtienen los
	 * datos de Interpol creado y concuerdan con los ingresados<br>
	 */
	public void testCargarJuego( )
	{
		...
		try
		{
			...
			assertNotNull( "La lista del camino a la respuesta no debería ser null", interpol.darCaminoRespuesta( ) );
			assertEquals( "La lista del camino a la respuesta debería tener 3 elementos", 3,
					interpol.darCaminoRespuesta( ).size( ) );
			assertNotNull( "El caso sobre el que se esta trabajando no puede ser null", interpol.darCaso( ) );
			...
			assertNotNull( "La lista del recorrido por inorden no debería ser null", interpol.darInorden( ) );
			assertEquals( "El tamaño de la lista del recorrido por inordenn debería ser 7", 7,
					interpol.darInorden( ).size( ) );
			assertNotNull( "La lista de los nombres de los lugares de la ciudad actual no debería ser null",
					interpol.darNombresLugaresCiudadActual( ) );
			assertEquals( "El tamaño de la lista de los nombres de los lugares de la ciudad actual debería ser 3", 3,
					interpol.darNombresLugaresCiudadActual( ).size( ) );
			assertNotNull( "La lista de los nombres de los posibles destinos de la ciudad actual no debería ser null",
					interpol.darNombresPosiblesDestinos( ) );
			assertEquals( "El tamaño de la lista de los posibles destinos de la ciudad actual debería ser 3", 3,
					interpol.darNombresPosiblesDestinos( ).size( ) );
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * ciudadActualEsHoja<br>
	 * <b> Objetivo: </b> Probar que se evalúa correctamente a la ciudad actual
	 * cuando es un árbol que es una hoja<br>
	 * <b> Resultados esperados: </b> <br>
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darCaminoRespuesta<br>
	 * <b> Objetivo: </b> Probar que se obtiene el camino a la respuesta cuando es
	 * un árbol que es una hoja<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se construye Interpol cuyo árbol solo es una hoja<br>
	...
	public void testDarCaminoRespuestaHoja( )
	{
		...
		assertEquals( "El tamaño de la lista del camino a la respuesta debería tener un elemento", 1,
				interpol.darCaminoRespuesta( ).size( ) );
		assertEquals( "El camino a la ciudad a la respuesta es incorrecto", "Bogotá",
				interpol.darCaminoRespuesta( ).get( 0 ) );
	}
	 ...
	 * 2. Se obtiene la lista del camino a la respuesta.<br>
	 * 3. La lista debe tener el primer elemento "Bogotá", luego "Cartagena", y
	 * luego "Leticia"<br>
	 */
	public void testDarCaminoRespuesta( )
	{
		setupEscenario3( );
		assertNotNull( "La lista del camino respuesta no debería ser null", interpol.darCaminoRespuesta( ) );
		assertEquals( "El tamaño de la lista del camino a la respuesta debería tener 3 elementos", 3,
				interpol.darCaminoRespuesta( ).size( ) );
		assertEquals( "El camino a la ciudad a la respuesta es incorrecto", "Bogotá",
				interpol.darCaminoRespuesta( ).get( 0 ) );
		assertEquals( "El camino a la ciudad a la respuesta es incorrecto", "Cartagena",
				interpol.darCaminoRespuesta( ).get( 1 ) );
		assertEquals( "El camino a la ciudad a la respuesta es incorrecto", "Leticia",
				interpol.darCaminoRespuesta( ).get( 2 ) );
	}
	...
	public void testDarCaso( )
	{
		...
		assertEquals( "El caso no es correcto", "Alguien se ha robado el Poporo Quimbaya del Museo del Oro",
				interpol.darCaso( ) );
	}
	...
	/**
	 * Este método se encarga de verificar el método
	 * darNombresLugaresCiudadActual<br>
	 * <b> Métodos a probar: </b> <br>
	 * darNombresLugaresCiudadActual<br>
	 * viajar<br>
	 * <b> Objetivo: </b> Probar que se obtienen correctamente los lugares para
	 * buscar pistas<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se construye Interpol con un árbol<br>
	 * 2. Se obtienen los 3 lugares para buscar pistas de la ciudad actual, que es
	 * la raíz<br>
	 * 3. Se viaja a una de las ciudades hijas de la raíz. A Cartagena<br>
	 * 4. Se obtienen los 2 lugares para buscar pistas de la ciudad actual, que es
	 * Cartagena<br>
	 */
	public void testDarNombresLugaresCiudadActual( )
	{
		...
		assertTrue( "Debería contener a la Agencia de Viajes como lugar para buscar pistas",
				respuesta.contains( "Agencia de Viajes" ) );
		assertTrue( "Debería contener a la Biblioteca como lugar para buscar pistas",
				respuesta.contains( "Biblioteca" ) );
	 ...
	 * darNombresPosiblesDestinos<br>
	 * viajar<br>
	 * <b> Objetivo: </b> Probar que se obtienen correctamente los nombres de los
	 * posibles destinos de la ciudad actual<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se construye Interpol con un árbol<br>
	 * 2. Se obtienen los 3 nombres de los posibles destinos para viajar de la
	 * ciudad actual, que es la raíz<br>
	 * 3. Los nombres que debe contener la lista son Cartagena, Barranquilla, San
	 * Andrés. 3. Se viaja a una de las ciudades hijas de la raíz. A
	 * Barranquilla<br>
	...
	public void testDarNombresPosiblesDestinos( )
	{
		...
		assertTrue( "La lista de posibles destinos debería contener a Barranquilla",
				respuesta.contains( "Barranquilla" ) );
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darNombresLugaresCiudadActual<br>
	 * <b> Objetivo: </b> Probar que se obtienen correctamente las pistas dado un
	 * lugar de la ciudad actual<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se construye Interpol con un árbol<br>
	 * 2. Se obtienen los 3 lugares para buscar pistas de la ciudad actual, que es
	 * la raíz<br>
	 * 3. Se obtienen las pistas de esos lugares y se comparan para ver si están
	 * correctas<br>
	 */
	public void testDarPistaLugar( )
	{
		...
		assertEquals( "La pista es incorrecta",
				"Mucha gente visitó el museo, pero había una persona particularmente interesada en las medidas de seguridad, pero nadie recuerda como es.",
				pista );
		pista = interpol.darPistaLugar( (String) interpol.darNombresLugaresCiudadActual( ).get( 1 ) );
		assertNotNull( "La pista del lugar no puede ser null", pista );
		assertEquals( "La pista es incorrecta",
				"Una persona estaba interesada por conocer los viajes mas inmediatos hacia la ciudad amurallada",
				pista );
		pista = interpol.darPistaLugar( (String) interpol.darNombresLugaresCiudadActual( ).get( 2 ) );
		assertNotNull( "La pista del lugar no puede ser null", pista );
		assertEquals(
				"Una persona estaba muy interesada en saber cuales eran las ciudades puerto de Colombia por las cuales salía el trafico de obras culturales del Colombia.",
				pista );
	}
	...
	public void testDarPrimeraCiudad( )
	{
		...
		assertEquals( "El nombre de la primera ciudad es incorrecto", "Bogotá",
				interpol.darPrimeraCiudad( ).darNombreCiudad( ) );
	}
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * darSospechosos<br>
	 * <b> Objetivo: </b> Probar que se obtiene correctamente la lista de
	 * sospechosos<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se construye Interpol con un árbol<br>
	 ...
	 * ordenCapturaGenerada<br>
	 * generarOrdenCaptura<br>
	 * <b> Objetivo: </b> Probar que se genera informa si se genero correctamente la
	 * orden de captura<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se construye Interpol con un árbol<br>
	 * 2. Se obtienen el primer sospechoso y no se genera la orden de captura<br>
	 ...
	 * viajar<br>
	 * <b> Objetivo: </b> Probar que se informa si esta en la ciudad con el
	 * sospechoso<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se construye Interpol con un árbol<br>
	 * 2. Se pregunta en la primera ciudad si esta el sospechoso, no se
	 * encuentra<br>
	 * 3. Se viaja a otra ciudad<br>
	 * 4. Se pregunta a la siguiente ciudad si esta el sospechoso, no se
	 * encuentra<br>
	 * 5. Se viaja a otra ciudad<br>
	 * 6. Se pregunta a la siguiente ciudad si esta el sospechoso, si se
	 * encuentra<br>
	 */
	 ...
	 * <b> Métodos a probar: </b> <br>
	 * viajar<br>
	 * <b> Objetivo: </b> Probar que se viaja correctamente a la siguiente
	 * ciudad<br>
	 * <b> Resultados esperados: </b> <br>
	 * 1. Se construye Interpol con un árbol<br>
	 * 2. Se obtienen el primer sospechoso y no se genera la orden de captura<br>
	...
	{
		setupEscenario3( );
		assertEquals( "El nombre de la primera ciudad es inválido", "Bogotá",
				interpol.darCiudadActual( ).darNombreCiudad( ) );
		interpol.viajar( "Cartagena" );
		assertEquals( "El nombre de la segunda ciudad es inválido", "Cartagena",
				interpol.darCiudadActual( ).darNombreCiudad( ) );
		interpol.viajar( "Leticia" );
		assertEquals( "El nombre de la tercera ciudad es inválido", "Leticia",
				interpol.darCiudadActual( ).darNombreCiudad( ) );
	}
